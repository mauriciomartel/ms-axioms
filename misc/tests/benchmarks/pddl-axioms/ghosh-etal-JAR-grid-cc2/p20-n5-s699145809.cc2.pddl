(DEFINE (PROBLEM N5-S699145809) (:DOMAIN GRID)
 (:OBJECTS BORDER - CELL C2 - CELL C1 - CELL B3 - CELL B2 - CELL A2 - CELL A1 -
  CELL)
 (:INIT (DISPENSER A1) (PROC A2) (PROC B2) (PROC B3) (PROC C1) (PROC C2)
  (REJECT A1 LEFT) (REJECT A1 RIGHT) (REJECT A1 UP) (REJECT A1 DOWN)
  (AVAILABLE A2) (AVAILABLE B2) (AVAILABLE B3) (AVAILABLE C1) (AVAILABLE C2)
