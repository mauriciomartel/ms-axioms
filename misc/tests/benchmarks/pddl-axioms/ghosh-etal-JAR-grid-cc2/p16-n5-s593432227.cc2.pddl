(DEFINE (PROBLEM N5-S593432227) (:DOMAIN GRID)
 (:OBJECTS BORDER - CELL C1 - CELL C0 - CELL B2 - CELL B1 - CELL B0 - CELL A1 -
  CELL)
 (:INIT (PROC A1) (PROC B0) (PROC B1) (DISPENSER B2) (PROC C0) (PROC C1)
  (AVAILABLE A1) (AVAILABLE B0) (AVAILABLE B1) (REJECT B2 LEFT)
  (REJECT B2 RIGHT) (REJECT B2 UP) (REJECT B2 DOWN) (AVAILABLE C0)
  (AVAILABLE C1) (REJECT BORDER LEFT) (REJECT BORDER RIGHT) (REJECT BORDER UP)
  ...
  (NEIGHBOUR DOWN B0 BORDER) (NEIGHBOUR DOWN C0 B0) (NEIGHBOUR UP B0 C0)
  ...
  (NEIGHBOUR UP BORDER B2) (NEIGHBOUR DOWN B2 BORDER)
  (NEIGHBOUR DOWN BORDER B2) (NEIGHBOUR UP B2 BORDER)
  (NEIGHBOUR LEFT BORDER C0) (NEIGHBOUR RIGHT C0 BORDER)
  (NEIGHBOUR RIGHT C1 C0) (NEIGHBOUR LEFT C0 C1) (NEIGHBOUR DOWN BORDER C0)
  (NEIGHBOUR UP C0 BORDER) (NEIGHBOUR RIGHT BORDER C1)
  (NEIGHBOUR LEFT C1 BORDER) (NEIGHBOUR DOWN BORDER C1)
