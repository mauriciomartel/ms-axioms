(DEFINE (PROBLEM N5-S679564268) (:DOMAIN GRID)
 (:OBJECTS BORDER - CELL C2 - CELL C1 - CELL C0 - CELL B2 - CELL B1 - CELL B0 -
  CELL)
 (:INIT (PROC B0) (PROC B1) (PROC B2) (DISPENSER C0) (PROC C1) (PROC C2)
  (AVAILABLE B0) (AVAILABLE B1) (AVAILABLE B2) (REJECT C0 LEFT)
  (REJECT C0 RIGHT) (REJECT C0 UP) (REJECT C0 DOWN) (AVAILABLE C1)
  (AVAILABLE C2) (REJECT BORDER LEFT) (REJECT BORDER RIGHT) (REJECT BORDER UP)
  (REJECT BORDER DOWN) (NEIGHBOUR LEFT BORDER B0) (NEIGHBOUR RIGHT B0 BORDER)
  ...
  (NEIGHBOUR RIGHT BORDER B2) (NEIGHBOUR LEFT B2 BORDER)
  (NEIGHBOUR UP BORDER B2) (NEIGHBOUR DOWN B2 BORDER) (NEIGHBOUR DOWN C2 B2)
  (NEIGHBOUR UP B2 C2) (NEIGHBOUR LEFT BORDER C0) (NEIGHBOUR RIGHT C0 BORDER)
