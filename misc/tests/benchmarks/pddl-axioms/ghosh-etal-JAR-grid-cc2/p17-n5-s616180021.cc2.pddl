(DEFINE (PROBLEM N5-S616180021) (:DOMAIN GRID)
 (:OBJECTS BORDER - CELL C2 - CELL C1 - CELL C0 - CELL B2 - CELL A2 - CELL A1 -
  CELL)
 (:INIT (DISPENSER A1) (PROC A2) (PROC B2) (PROC C0) (PROC C1) (PROC C2)
  (REJECT A1 LEFT) (REJECT A1 RIGHT) (REJECT A1 UP) (REJECT A1 DOWN)
  (AVAILABLE A2) (AVAILABLE B2) (AVAILABLE C0) (AVAILABLE C1) (AVAILABLE C2)
  ...
  (NEIGHBOUR DOWN A1 BORDER) (NEIGHBOUR DOWN BORDER A1)
  (NEIGHBOUR UP A1 BORDER) (NEIGHBOUR RIGHT BORDER A2)
  ...
  (NEIGHBOUR UP BORDER C1) (NEIGHBOUR DOWN C1 BORDER)
