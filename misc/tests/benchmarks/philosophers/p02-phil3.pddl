...
(:init
  ...
  ;; philosopher-2: own=forks-2-, next=forks-0- (ring wrap)

  (writes philosopher-2 forks-2- forks--pid-Wfork)

  (reads philosopher-2 forks-2- forks--pid-Rfork)

  (reads philosopher-2 forks-0- forks-__-pidp1__2_-Rfork)

  (writes philosopher-2 forks-0- forks-__-pidp1__2_-Wfork)
