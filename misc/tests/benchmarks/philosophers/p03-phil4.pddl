...
(:init
  ...
  ;; philosopher-0: own=forks-0-, next=forks-1-
  ...
  ;; philosopher-1: own=forks-1-, next=forks-2-

  (writes philosopher-1 forks-1- forks--pid-Wfork)

  (reads philosopher-1 forks-1- forks--pid-Rfork)

  (reads philosopher-1 forks-2- forks-__-pidp1__2_-Rfork)

  (writes philosopher-1 forks-2- forks-__-pidp1__2_-Wfork)

  ;; philosopher-2: own=forks-2-, next=forks-3-

  (writes philosopher-2 forks-2- forks--pid-Wfork)

  (reads philosopher-2 forks-2- forks--pid-Rfork)

  (reads philosopher-2 forks-3- forks-__-pidp1__2_-Rfork)

  (writes philosopher-2 forks-3- forks-__-pidp1__2_-Wfork)

  ;; philosopher-3: own=forks-3-, next=forks-0- (ring wrap)

  (writes philosopher-3 forks-3- forks--pid-Wfork)

  (reads philosopher-3 forks-3- forks--pid-Rfork)

  (reads philosopher-3 forks-0- forks-__-pidp1__2_-Rfork)

  (writes philosopher-3 forks-0- forks-__-pidp1__2_-Wfork)
