(DEFINE (PROBLEM N5-S648100000) (:DOMAIN GRID)
 (:OBJECTS BORDER - CELL C2 - CELL C1 - CELL B2 - CELL B1 - CELL A2 - CELL A1 -
  CELL)
 (:INIT (PROC A1) (PROC A2) (PROC B1) (PROC B2) (DISPENSER C1) (PROC C2)
  (AVAILABLE A1) (AVAILABLE A2) (AVAILABLE B1) (AVAILABLE B2) (REJECT C1 LEFT)
